...
func GetSetFile(key string) string {
	// 读取文件
...
func GetSetString(key string) string {
	return configKeyValue[key]
}

// 返回int
func GetSetInt(key string) int {
...
func GetSetInt16(key string) int16 {
	i := ReadInt(key)
	// 如果大于取值区间，返回0
...
func GetSetUint64(key string) uint64 {
...
// 2边需要用到引号
func GetSetPassword(key string) string {
...
func GetSetBool(key string) bool {
	if _, ok := configKeyValue[key]; ok {
...
func GetSetInt64(key string) int64 {
